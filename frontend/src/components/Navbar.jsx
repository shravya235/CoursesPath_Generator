...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-light-navbar-bg dark:bg-[#0a0f23]/90 backdrop-blur-lg z-50 border-b border-cyan-700/50 shadow-lg shadow-cyan-900/50">
